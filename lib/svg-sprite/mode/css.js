    ...
    _layoutSimple(pseudoShapeMap) {
        ...
        this._spriter._shapes.forEach((shape, index) => {
            ...
            // TODO clear up fourth param
                this._addShapeToSimpleCssSprite(shape, pseudoShapeMap[shape.base], index, !index + ((index === lastShape) * 2));
            }
        });
        return this;
    }
    ...
    _layoutBinPacked(pseudoShapeMap) {
        ...
        this._spriter._shapes.forEach((shape, index) => {
            ...
            if (!shape.master) {
                ...
                this._addShapeToCSSSprite(shape, pseudoShapeMap[shape.base], index, !index + ((index === lastShape) * 2), this._refineRootAttributes(shape, index, rootAttributes), -position.x, -position.y);
            }
        });
